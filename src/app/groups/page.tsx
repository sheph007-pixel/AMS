...
export default function GroupsPage() {
  ...
  return (
    <div>
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold tracking-tight text-bob-text">Client Groups</h1>
        <p className="text-bob-text-soft mt-1">Book of business — all active groups in your employee benefits program</p>
      </div>
